...
public:
    ...
    void setupUi(QDialog *OBSBasicSettings)
    {
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 806, 1181));
        ...
        simpleOutputContainer = new QFrame(easyOutputsPage);
        ...
        verticalLayout_3->addWidget(simpleOutputContainer);
        ...
        advOutRecTopContainer = new QFrame(advOutRecStandard);
        ...
        widget_7 = new QFrame(advOutRecStandard);
        ...
        scrollAreaWidgetContents_50->setGeometry(QRect(0, 0, 820, 641));
        ...
        hotkeyFilterReset->setMinimumSize(QSize(24, 24));
        hotkeyFilterReset->setMaximumSize(QSize(24, 24));
        hotkeyFilterReset->setBaseSize(QSize(24, 24));
        hotkeyFilterReset->setFlat(true);
        hotkeyFilterReset->setProperty("fixedSize", QVariant(QSize(24, 24)));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 609, 870));
...
#endif // QT_CONFIG(tooltip)
        hotkeyFilterReset->setProperty("themeID", QVariant(QCoreApplication::translate("OBSBasicSettings", "trashIcon", nullptr)));
