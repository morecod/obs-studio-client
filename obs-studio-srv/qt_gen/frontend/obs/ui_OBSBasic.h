...
public:
    ...
    void setupUi(QMainWindow *OBSBasic)
    {
        ...
        sizePolicy3.setHeightForWidth(contextSourceIcon->sizePolicy().hasHeightForWidth());
        contextSourceIcon->setSizePolicy(sizePolicy3);
        ...
        sizePolicy4.setHeightForWidth(contextSourceLabel->sizePolicy().hasHeightForWidth());
        contextSourceLabel->setSizePolicy(sizePolicy4);
        ...
        sizePolicy3.setHeightForWidth(contextSourceIconSpacer->sizePolicy().hasHeightForWidth());
        contextSourceIconSpacer->setSizePolicy(sizePolicy3);
        ...
        sizePolicy5.setHeightForWidth(sourcePropertiesButton->sizePolicy().hasHeightForWidth());
        sourcePropertiesButton->setSizePolicy(sizePolicy5);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/res/images/filter.svg"), QSize(), QIcon::Normal, QIcon::Off);
        sourceFiltersButton->setIcon(icon6);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/res/images/interact.svg"), QSize(), QIcon::Normal, QIcon::Off);
        sourceInteractButton->setIcon(icon7);
        ...
        sizePolicy6.setHeightForWidth(emptySpace->sizePolicy().hasHeightForWidth());
        emptySpace->setSizePolicy(sizePolicy6);
        ...
        sizePolicy7.setHeightForWidth(scenes->sizePolicy().hasHeightForWidth());
        scenes->setSizePolicy(sizePolicy7);
        ...
        sizePolicy7.setHeightForWidth(sources->sizePolicy().hasHeightForWidth());
        sources->setSizePolicy(sizePolicy7);
        ...
        hVolumeWidgets->setGeometry(QRect(0, 0, 67, 16));
        QSizePolicy sizePolicy8(QSizePolicy::Preferred, QSizePolicy::Maximum);
        sizePolicy8.setHorizontalStretch(0);
        sizePolicy8.setVerticalStretch(0);
        sizePolicy8.setHeightForWidth(hVolumeWidgets->sizePolicy().hasHeightForWidth());
        hVolumeWidgets->setSizePolicy(sizePolicy8);
        ...
        sizePolicy9.setHeightForWidth(vVolumeWidgets->sizePolicy().hasHeightForWidth());
        vVolumeWidgets->setSizePolicy(sizePolicy9);
        ...
        transitionsContainer = new QFrame(dockWidgetContents_5);
        ...
        sizePolicy10.setHeightForWidth(transitionProps->sizePolicy().hasHeightForWidth());
        transitionProps->setSizePolicy(sizePolicy10);
        ...
        sizePolicy9.setHeightForWidth(transitionDurationLabel->sizePolicy().hasHeightForWidth());
        transitionDurationLabel->setSizePolicy(sizePolicy9);
        ...
        sizePolicy11.setHeightForWidth(streamButton->sizePolicy().hasHeightForWidth());
        streamButton->setSizePolicy(sizePolicy11);
        ...
        sizePolicy11.setHeightForWidth(broadcastButton->sizePolicy().hasHeightForWidth());
        broadcastButton->setSizePolicy(sizePolicy11);
        ...
        sizePolicy11.setHeightForWidth(recordButton->sizePolicy().hasHeightForWidth());
        recordButton->setSizePolicy(sizePolicy11);
        ...
        sizePolicy11.setHeightForWidth(modeSwitch->sizePolicy().hasHeightForWidth());
        modeSwitch->setSizePolicy(sizePolicy11);
        ...
        sizePolicy11.setHeightForWidth(settingsButton->sizePolicy().hasHeightForWidth());
        settingsButton->setSizePolicy(sizePolicy11);
        ...
        sizePolicy11.setHeightForWidth(exitButton->sizePolicy().hasHeightForWidth());
        exitButton->setSizePolicy(sizePolicy11);
        ...
        menuDocks->addAction(lockUI);
        menuDocks->addAction(resetUI);
    ...
    void retranslateUi(QMainWindow *OBSBasic)
    {
        ...
        resetUI->setText(QCoreApplication::translate("OBSBasic", "Basic.MainMenu.Docks.ResetUI", nullptr));
        lockUI->setText(QCoreApplication::translate("OBSBasic", "Basic.MainMenu.Docks.LockUI", nullptr));
