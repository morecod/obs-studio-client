...
if (NOT TARGET Qt5::Network)
    ...
    set_property(TARGET Qt5::Network PROPERTY INTERFACE_QT_ENABLED_FEATURES networkinterface;bearermanagement;dnslookup;schannel;ftp;http;localserver;networkdiskcache;networkproxy;socks5;ssl;sspi;udpsocket)
    set_property(TARGET Qt5::Network PROPERTY INTERFACE_QT_DISABLED_FEATURES securetransport;dtls;gssapi;opensslv11;ocsp;sctp)

    # Qt 6 forward compatible properties.
    set_property(TARGET Qt5::Network
                 PROPERTY QT_ENABLED_PUBLIC_FEATURES
                 networkinterface;bearermanagement;dnslookup;schannel;ftp;http;localserver;networkdiskcache;networkproxy;socks5;ssl;sspi;udpsocket)
    set_property(TARGET Qt5::Network
                 PROPERTY QT_DISABLED_PUBLIC_FEATURES
                 securetransport;dtls;gssapi;opensslv11;ocsp;sctp)
    set_property(TARGET Qt5::Network
